			...
			<div class="container">
				<div class="page-title-wrap text-center w-100">
					<div class="page-title-inner d-inline-block">
						<h1 class="mb-0">SDGs Desa <?= $desa["nama_desa"] ?></h1>
						<ol class="breadcrumb mb-0">
							<li class="breadcrumb-item"><a href="<?= base_url(); ?>" title="Beranda">Beranda</a></li>
							<li class="breadcrumb-item active">SDGs Desa <?= $desa["nama_desa"] ?></li>
						</ol>
					</div>
				</div><!-- Page Title Wrap -->
			</div>
			...
			<div class="container">
				<div class="row">
					...
					<?php
						...
						$url = 'https://sid.kemendesa.go.id/home/sdgs/3514212010';
