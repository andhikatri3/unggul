			...
			<div class="container">
				<div class="page-title-wrap text-center w-100">
					<div class="page-title-inner d-inline-block">
						<h1 class="mb-0">Pagu Dana Desa <?= $desa["nama_desa"] ?></h1>
						<ol class="breadcrumb mb-0">
							<li class="breadcrumb-item"><a href="<?= base_url(); ?>" title="Beranda">Beranda</a></li>
							<li class="breadcrumb-item active">Pagu Dana Desa <?= $desa["nama_desa"] ?></li>
						</ol>
					</div>
				</div><!-- Page Title Wrap -->
			</div>
			...
			<div class="container">
				<div class="row">
					...
					<?php
						...
						$url = 'https://sid.kemendesa.go.id/home/dd/3514212010';
						$content = file_get_contents($url);
						$first_step = explode( '<div class="colr-area">' , $content );
