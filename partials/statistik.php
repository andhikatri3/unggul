		...
		<div class="container">
			<div class="page-title-wrap text-center w-100">
				<div class="page-title-inner d-inline-block">
					<h1 class="mb-0">Data Demografi </h1>
					<ol class="breadcrumb mb-0">
						<li class="breadcrumb-item"><a href="<?= base_url(); ?>" title="Home">Beranda</a></li>
						<li class="breadcrumb-item active">Data Demografi </li>
					</ol>
				</div>
			</div><!-- Page Title Wrap -->
		</div>
			...
			<div class="post-detail-wrap w-100">
				<div class="row">
					<div class="col-md-12 col-sm-12 col-lg-12">					
						<h2>Data Demografi Berdasarkan <?= $heading ?></h2>					
						<div class="box-stats d-flex justify-content-end">
							<div class="btn-group-xs">
								<button class="btn thm-bg <?= ($tipe==1) ? 'btn-primary' : 'btn-warning' ?> btn-xs" onclick="switchType();">Bar Graph</button>
								<button class="btn thm-bg <?= ($tipe==0) ? 'btn-primary' : 'btn-warning' ?> btn-xs" onclick="switchType();">Pie Cart</button>
							</div>
						</div>
						
						<div id="container" class="pb-80"></div>
						<div id="contentpane">
						...
						<div class="table-responsive">
							...
							<?php if($hide=="lebih"):?>
								<div style='float: left;'>
									<button class='btn thm-bg' id='showData'>Selengkapnya...</button>
								</div>
							<?php endif;?>
							<div style="float: right;">
								<button id='tampilkan' onclick="toggle_tampilkan();" class="btn thm-bg">Tampilkan Nol</button>
							</div>
						</div>			
					</div>
				</div>
