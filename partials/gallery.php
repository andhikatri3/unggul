			...
			<div class="container">
				<div class="page-title-wrap text-center w-100">
					<div class="page-title-inner d-inline-block">
						<h1 class="mb-0">Galeri Album <?= $desa["nama_desa"] ?></h1>
						<ol class="breadcrumb mb-0">
							<li class="breadcrumb-item"><a href="<?= base_url(); ?>" title="Beranda">Beranda</a></li>
							<li class="breadcrumb-item active">Galeri Album</li>
						</ol>
					</div>
				</div>
			</div>
		...
		<div class="w-100 pt-120 pb-250 position-relative">
			...
			<div class="container">
							...
							<div class="col-md-6 col-sm-6 col-lg-4">
								<div class="gallery-box text-center overflow-hidden position-relative w-100">
									...
									<div class="gallery-info position-absolute">
										<h3 class="mb-0">Album : '. $data["nama"].'</h3>										
				...
				<div class="pagination-wrap mt-40 d-flex flex-wrap justify-content-center text-center w-100">
					...
					echo ' <li class="page-item prev"><a class="page-link" href="'.site_url("first/gallery/$paging->start_link").'" title="Halaman Pertama">
					...
					foreach($pages as $i) {
						$strC = ($p == $i)? 'active' : '';
						echo'<li class="page-item '.$strC.'"><a class="page-link" href="'.site_url("first/gallery/$i").'" title="Halaman '.$i.'">'.$i.'</a></li>';
					}
					...
					if($paging->end_link){
						echo "<li class='page-item next'><a class='page-link' href=\"".site_url("first/gallery/$paging->end_link")."\" title=\"Halaman Terakhir\">
