...
<meta name='theme:designer' content='Andhika Tri' />
<meta name="author" content="Andhika Tri">
...
<meta name="description" content="<?= $this->setting->website_title.' '.ucwords($this->setting->sebutan_desa).' '.$desa['nama_desa'].' '.ucwords($this->setting->sebutan_kecamatan).' '.$desa['nama_kecamatan'].' '.ucwords($this->setting->sebutan_kabupaten).' '.$desa['nama_kabupaten'];?>">
...
<?php endif;?>
  ...
  <meta name="theme-color" content="#21a010">
  
  	<link rel="stylesheet" href="<?= base_url("$this->theme_folder/$this->theme/"); ?>assets/css/all.min.css">
	...
	<link rel="stylesheet" href="<?= base_url("$this->theme_folder/$this->theme/"); ?>assets/css/jquery.bootstrap-touchspin.min.css">
	<link rel="stylesheet" href="<?= base_url("$this->theme_folder/$this->theme/"); ?>assets/css/perfect-scrollbar.css">
	...
	<link rel="stylesheet" href="<?= base_url("$this->theme_folder/$this->theme/"); ?>assets/css/color.css">
<!-- Owl Stylesheets -->
  <link rel="stylesheet" href="<?= base_url("$this->theme_folder/$this->theme/"); ?>assets/owlcarousel/assets/owl.carousel.min.css">
  <link rel="stylesheet" href="<?= base_url("$this->theme_folder/$this->theme/"); ?>assets/owlcarousel/assets/owl.theme.default.min.css">
...
<script type="text/javascript">
	...
	function renderDate()
	{
		...
		if (seconds <= 9)
			seconds = "0" + seconds;
		document.getElementById("jam").innerHTML = "<B>"+days[day]+", "+daym+" "+months[month]+" "+year+"</B>&nbsp; "+hours+" : "+minutes+" : "+seconds;
